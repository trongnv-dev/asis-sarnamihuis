...
const Action = (props) => {
  const { id, handlePopupUpdateSysAttSub, handlePopupDeleteSysAttSub, label } = props;
  const isUpdate = true;
  ...
  const menuList = [
    <Tooltip title={<ChangeLabel label={label.tooltipUpdate} />} placement="right">
      <div>
        <Button variant="outline-primary" onClick={() => (isSwitch ? null : handlePopupUpdateSysAttSub(id, isUpdate))}>
    ...
    <Tooltip title={<ChangeLabel label={label.tooltipDelete} />} placement="right">
      <div>
        <Button variant="outline-primary" onClick={() => (isSwitch ? null : handlePopupDeleteSysAttSub(id))}>
    ...
    <Tooltip title={<ChangeLabel label={label.tooltipDetail} />} placement="right">
      <div>
        <Button variant="outline-success" onClick={() => (isSwitch ? null : handlePopupUpdateSysAttSub(id, !isUpdate))}>
