...
const Action = (props) => {
  const { id, handlePopupUpdateSysAttMain, handlePopupDeleteSysAttMain, label, handleShowSysAttSub, sysAttMainName } = props;
  const isUpdate = true;
  ...
  const menuList = [
    <Tooltip title={<ChangeLabel label={label.tooltipUpdate} />} placement="right">
      <div>
        <Button variant="outline-primary" onClick={() => (isSwitch ? null : handlePopupUpdateSysAttMain(id, isUpdate))}>
    ...
    <Tooltip title={<ChangeLabel label={label.tooltipDelete} />} placement="right">
      <div>
        <Button variant="outline-primary" onClick={() => (isSwitch ? null : handlePopupDeleteSysAttMain(id))}>
    ...
    <Tooltip title={<ChangeLabel label={label.tooltipExpand} />} placement="right">
      <div>
        <Button variant="outline-primary" onClick={() => (isSwitch ? null : handleShowSysAttSub(id, sysAttMainName))}>
    ...
    <Tooltip title={<ChangeLabel label={label.tooltipDetail} />} placement="right">
      <div>
        <Button variant="outline-success" onClick={() => (isSwitch ? null : handlePopupUpdateSysAttMain(id, !isUpdate))}>
