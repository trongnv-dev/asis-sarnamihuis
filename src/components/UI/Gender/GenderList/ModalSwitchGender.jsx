...
const ModalSwitchGender = (props) => {
  const { popUpConfirm, setPopUpConfirm, currentIdGender, setIsReloadData, isReloadData, isActive } = props;
  const [isLoading, setIsLoading] = useState(false);

  const switchActiveGender = async (currentIdGender) => {
    setIsLoading(true);
    try {
      const response = await genderApi.switchActiveGender(currentIdGender);
      ...
      <Modal show={popUpConfirm} centered>
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            onClick={() => switchActiveGender(currentIdGender)}
...
export default ModalSwitchGender;
