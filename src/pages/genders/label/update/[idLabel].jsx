...
function UpdateLabelGenderModal() {
  ...
  // Update Gender Label
  const updateGenderLabel = async (formData) => {
    setLoading(true);
    try {
      const res = await genderApi.editGenderLabel({
    ...
    <>
      ...
      <Container fluid>
        {pageLoading ? (
          ...
          <>
            {data.idLabel && (
              <form onSubmit={handleSubmit(updateGenderLabel)}>
                {/* id */}
...
export default withAuth(withLayout(UpdateLabelGenderModal));
